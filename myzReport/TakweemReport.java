...
//        m_window.show();
    ...
    public void addPatientName()
    {
        ...
        String patientName = m_patientName.getText();
        ...
        if ( patientName != null && patientName.length() > 0)
        {
            ...
            cell = new PdfPCell();
            cell.setPhrase(new Phrase(patientName));
            cell.setBorder(PdfPCell.NO_BORDER);
            cell.setHorizontalAlignment( PdfPCell.ALIGN_CENTER );
...
//            m_pdfDocument.add(dateInfoTable);
    ...
    public void addImage()
    {
        ...
        // TODO the report can not take the javafx image si we will take it again
        imageTable.addCell("asdsad");
    }
